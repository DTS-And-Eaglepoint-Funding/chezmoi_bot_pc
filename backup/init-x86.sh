#!/bin/bash
echo "Running x86 initialization script..."
...
# x86_64 only
yay -S git-credential-manager git-credential-manager-extras google-chrome chromedriver anydesk-bin carapace-bin
# end of x86_64 only
yay -S teamviewer fwupd geckodriver python-pipx tailscale yaycache-hook paccache-hook jq


echo "Setting up git credentials manager..."
...
sudo sh -c "curl https://mise.jdx.dev/mise-latest-linux-x64 > /usr/bin/mise"
...
echo "x86 Installation script completed successfully."
